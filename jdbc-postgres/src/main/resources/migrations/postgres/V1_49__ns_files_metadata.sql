CREATE TABLE IF NOT EXISTS namespace_file_metadata (
    ...
    "parent_path" VARCHAR(350) NOT NULL GENERATED ALWAYS AS (value ->> 'parentPath') STORED,
...
CREATE INDEX IF NOT EXISTS ix_last_deleted_tenant_namespace_path ON kv_metadata ("directory", "last", "deleted", "tenant_id", "namespace", "path");
CREATE INDEX IF NOT EXISTS ix_last_deleted_tenant_namespace_parent_path ON kv_metadata ("directory", "last", "deleted", "tenant_id", "namespace", "parentPath");
